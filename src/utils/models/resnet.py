...
def ResNet18(num_classes=10, channels=3):
    return ModifiedResNet(BasicBlock, [2,2,2,2], num_classes, channels)

def ResNet34(num_classes=10, channels=3):
    return ModifiedResNet(BasicBlock, [3,4,6,3], num_classes, channels)


def ResNet50(num_classes=10, channels=3):
    return ModifiedResNet(Bottleneck, [3,4,6,3], num_classes, channels)


def ResNet101(num_classes=10, channels=3):
    return ModifiedResNet(Bottleneck, [3,4,23,3], num_classes, channels)
...
class OriginalResNet(nn.Module):
    def __init__(self, num_classes=1000, pretrained=False, channels=3):
...
class OriginalResNet50(nn.Module):
    def __init__(self, num_classes=1000, pretrained=False, channels=3):
        super(OriginalResNet50, self).__init__()
        self.net = models.resnet50(pretrained)
